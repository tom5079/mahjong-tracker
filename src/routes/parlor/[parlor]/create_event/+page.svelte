        ...
        <div class="flex flex-col space-y-4">
            ...
            <div>
                <div class="flex flex-row items-center justify-between py-2">
                    <label for="ruleset" class="mb-2 block text-sm font-medium text-gray-900"
                        >Ruleset</label
                    >
                    <a
                        href="settings/ruleset/create"
                        class="rounded-lg bg-blue-500 px-5 py-2.5 text-white">New Ruleset</a
                    >
                </div>
                <select
                    id="ruleset"
            ...
            <Fieldset label="Join Policy">
                ...
                <div class="p-2" class:hidden={formData?.joinPolicy?.toString() !== 'auto'}>
                    <Label label="Until">
                        <Datetime
                            name="joinPolicyUntil"
                            min={DateTime.now().toISO().slice(0, 16)}
                        />
                    </Label>
                </div>
            </Fieldset>
