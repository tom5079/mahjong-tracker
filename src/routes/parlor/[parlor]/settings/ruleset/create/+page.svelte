    ...
    <section>
        <Form {onSubmit}>
            <div class="grid gap-6 py-4">
                ...
                <fieldset
                    class="space-y-2 rounded-lg border border-solid border-gray-300 px-2 pb-2"
                >
                ...
                <div>
                    <label for="honba" class="mb-2 block text-sm font-medium text-gray-900"
                        >Honba</label
                    >
                    <input
                        type="number"
                ...
                <div>
                    <label for="tenpai" class="mb-2 block text-sm font-medium text-gray-900"
                        >Tenpai fee</label
                    >
                    <input
                        type="number"
                ...
                <fieldset
                    class="space-y-4 rounded-lg border border-solid border-gray-300 px-2 pb-2"
                >
                    ...
                    <div class="flex flex-col space-y-4">
                        ...
                        <label class="inline-flex cursor-pointer items-center">
                            <input
                                type="checkbox"
                                class="peer sr-only"
                                bind:checked={chonbo.affectsScore}
                            />
                            <span class="ms-3 text-sm font-medium text-gray-900"
                                >Chonbo affects score</span
                            >
                            <div
                                class="peer relative ml-auto h-6 w-11 rounded-full bg-gray-200 after:absolute after:start-[2px] after:top-0.5 after:h-5 after:w-5 after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all after:content-[''] peer-checked:bg-blue-600 peer-checked:after:translate-x-full peer-checked:after:border-white peer-focus:ring-4 peer-focus:ring-blue-300 rtl:peer-checked:after:-translate-x-full"
                            ></div>
                ...
                <div>
                    <label class="mb-2 block text-sm font-medium text-gray-900" for="note"
                        >Note</label
                    >
                    <textarea
                        bind:value={note}
